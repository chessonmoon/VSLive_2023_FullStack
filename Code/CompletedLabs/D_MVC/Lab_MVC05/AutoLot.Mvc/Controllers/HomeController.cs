...
{
    //private readonly IAppLogging<HomeController> _logger = logger;
    ...
    [HttpGet]
    public IActionResult GetServiceTwo([FromKeyedServices(nameof(SimpleServiceTwo))] ISimpleService service)
    {
        return View("SimpleService",service.SayHello());
    }
